...
<img src="https://github.com/Ivan778/KeyHooker/blob/master/Images/keyboard.jpg" alt="What keys you allowed to lock" width="700">
  ...
  If you need to hide your app (for example, you disabled shortcuts and do not want to see app in your Dock), just type the next (commas are separators, don't type them):<br />
                                        <pre>CMD LEFT, CMD RIGHT, h, o, o, k, e, r</pre>
